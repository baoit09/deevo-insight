...
test('\n\n*** GRPC communication tests ***\n\n', (t) => {
	...
	utils.setConfigSetting('grpc.max_send_message_length', 1024 * 1024 * 10);
	// limit the send message size to 1M
	utils.setConfigSetting('grpc-max-send-message-length', 1024 * 1024 * 10);
	...
	.then((enrollment) => {
		...
		submitter = admin;
		//force the use of the old v1.0 way
		utils.setConfigSetting('grpc.max_receive_message_length', 1024 * 1024 * 10);
		// limit the send message size to 1M
		utils.setConfigSetting('grpc-max-receive-message-length', 1024 * 1024 * 10);
